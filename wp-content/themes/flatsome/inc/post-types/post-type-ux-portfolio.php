...
if (!class_exists('Featured_Item_Post_Type')) :
    ...
    class Featured_Item_Post_Type
    {
        ...
        {
            $labels = array(
                'name'               => __('Dự án kiến trúc', 'flatsome-admin'),
                'singular_name'      => __('Dự án kiến trúc', 'flatsome-admin'),
                'add_new'            => __('Add New', 'flatsome-admin'),
                'add_new_item'       => __('Add New', 'flatsome-admin'),
                'edit_item'          => __('Sửa dự án', 'flatsome-admin'),
                'new_item'           => __('Thêm mới dự án', 'flatsome-admin'),
                'view_item'          => __('Hiển thị bài viết', 'flatsome-admin'),
                'search_items'       => __('Tìm kiếm dự án', 'flatsome-admin'),
        ...
        protected function register_taxonomy_tag()
        {
            $labels = array(
                ...
                'edit_item'                  => __('Sửa Tag', 'flatsome-admin'),
...
//            register_taxonomy('featured_item_tag', array('featured_item'), $args);
        ...
        protected function register_taxonomy_category()
        {
            ...
            $labels = array(
                'name'                       => __('Danh mục dự án', 'flatsome-admin'),
                'singular_name'              => __('Danh mục dự án', 'flatsome-admin'),
                'menu_name'                  => __('Danh mục', 'flatsome-admin'),
                'edit_item'                  => __('Sửa danh mục', 'flatsome-admin'),
                'update_item'                => __('Update danh mục', 'flatsome-admin'),
                'add_new_item'               => __('Thêm mới danh mục', 'flatsome-admin'),
                'new_item_name'              => __('Danh mục mới', 'flatsome-admin'),
                'parent_item'                => __('Danh mục cha', 'flatsome-admin'),
                'parent_item_colon'          => __('Danh mục cha:', 'flatsome-admin'),
                'all_items'                  => __('Tất cả danh mục', 'flatsome-admin'),
                'search_items'               => __('Tìm danh mục', 'flatsome-admin'),
                'popular_items'              => __('Danh mục phổ biến', 'flatsome-admin'),
