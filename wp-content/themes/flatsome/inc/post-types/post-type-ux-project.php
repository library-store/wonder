...
if ( ! class_exists( 'Featured_Item_Post_Type' ) ) :
    ...
    class Featured_Item_Post_Type {
        ...
        protected function register_post_type() {
            $labels = array(
                'name'               => __( 'Dự án', 'flatsome-admin' ),
                'singular_name'      => __( 'Dự án', 'flatsome-admin' ),
            ...
            register_post_type( 'project_item', $args );
        }
        ...
        protected function register_taxonomy_category() {
            ...
            register_taxonomy( 'project_item_category', array( 'project_item' ), $args );
