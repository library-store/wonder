...
if ( ! function_exists( 'wonder_setup' ) ) :
	...
	function wonder_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'wonder_custom_background_args', array(
...
function wonder_scripts() {
	wp_enqueue_style( 'wonder-style', get_stylesheet_uri() );

	wp_enqueue_script( 'wonder-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wonder-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
